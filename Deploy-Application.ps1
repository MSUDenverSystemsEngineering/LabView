...
Try {
	...
	[string]$appVendor = 'NI'
	[string]$appName = 'LabVIEW Student Suite'
	[string]$appVersion = 'Spring 2020'
	[string]$appArch = 'x64'
	[string]$appLang = 'EN'
	...
	If ($deploymentType -ine 'Uninstall' -and $deploymentType -ine 'Repair') {
		...
		$tempExitCode = Execute-Process "$dirFiles\ni-labview-2020_20.0_suite_online_repack3.exe" -Parameters "--quiet --accept-eulas --prevent-reboot" -IgnoreExitCodes "-125071,-125083" -PassThru
		...
		## Remove shortcuts
		Remove-File -Path "$envCommonDesktop\VI Package Manager.lnk" -ContinueonError $True
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCBJ9vye8oamagJd
# XAmpJLcawA0XXAS+v8xO2wyIe1qsl6CCH8EwggVvMIIEV6ADAgECAhBI/JO0YFWU
...
# AYI3AgELMQ4wDAYKKwYBBAGCNwIBFTAvBgkqhkiG9w0BCQQxIgQgyOnRe2l28vuw
# n2zlK58tvBymY84g9Z2V4VSJKIQeFBUwDQYJKoZIhvcNAQEBBQAEggGAelqk3tJV
# LDOUR8LkR5WfZnFz77gBHszrdKmEjgpY5xbx1mdf+4+50mrK25UsY+U+0O7aEQ0X
# l/jwhN/2dv7cCF26vP+n2t4Rvf2zOxX9LPM7+dS8zd50CFRz/fYcQYHuVOxuN7R2
# I0A3AUqdhN8LALg8tR8eTDVcQsUnG8qTKfGci2oeFb4ZU4sfBQYujJHrqgoEG3M3
# +9HYqbThr894UtF+o1NAtdg1F1QacH+bm2cqRz4dBcXrrINGikjUL81w7VIHo1vs
# oQJS/Wy0mu3GI5IPGKX7Yta+JEBrrXd9reBzwt7uz17qK5Oq1hERXdkrsgGMZ9Bw
# NID+O0I7mQTiiO8bI9AuRxAI6aQhTdJ2MjO/LaykDPjrURDn11LzfHX6BFKKHUXP
# 92eYkh83+dD7WibM8CXdGtpL9Qb1Um93oNL0kEMLpOsfNeXynO9iHbsXrqEl75bm
# b4dhSyP95h/iYLuULZNB2fDaoHJMbQ/qzyOhTwbXZSM4PrPLAwRsp0qioYIDTDCC
...
# BgkqhkiG9w0BCQMxCwYJKoZIhvcNAQcBMBwGCSqGSIb3DQEJBTEPFw0yMjA4MDUy
# MjEzNTFaMD8GCSqGSIb3DQEJBDEyBDB4VQoOUBuF19mf4vJz/Iz6nugB2QHdt0zq
# spIURCYHQz0jJ+EAgQ0GkQ6q46UT6hwwDQYJKoZIhvcNAQEBBQAEggIADFe6RjR8
# 0L+fonPAmQnEx8h7NI+0rkgVS82rJEw/cs1TInpyOrbZAGyfFOa6e11bGV27lmsh
# VU+wRmEiewEeATxXwhsPPtLqQHb0ebLVNA+OjqR9I4zOge8d8mC75h7roKX2HJDr
# D24Tfi/FB3E2H7r5bXXcxj88QRSc8sq6S3vRwr8zO4xRlDN/ZmmrYS3p1Rfbn+Em
# IJxx79PZWOfmrB151hwagloVzyxAS+RbqsNrIS572PdKcW9AgxWuxjE1UhR4+Rmx
# XL/h1C+Z9jAnLQrGeg4E03zW6JOV3Q5y9qqUq9BNl8Z1NLxV5IQe/A6DA2aF2U75
# f+hSZdiIRC40NxACX1f1Y4yAT2oHV3A23p8vtI4VAf3qMlYxcJz/BMu+IVTvPexx
# S/83YW9I2SCZ3MKwE11LB0m3MeNjgqNTodydJg2sQ8s5khohzXcx3uxRyK2TNRTC
# 4HqLhwyzMwAbuowHxwPoBaJo+owHC30CffH+SBC1mXlQ6wzBtK5CcpBx9i8Vphte
# mOVvfDrjq4UFQQOFwKeGtr5RsXpku1t9oIaLMRagCjsHZqz6beFcwUnYpBe81vCF
# GMtQ/tp27DJz4Kvp8DXgNEpg3yWORM9QfCfxfDWrhDFflzCVop+S4LMmwVeKBXBT
# H/VQgGlfe98xFg73PoaK72A4Kj5GXknries=
